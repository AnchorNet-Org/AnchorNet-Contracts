...
list_settlements_by_anchor_asset(anchor, asset, start, limit)	–	Page through settlements matching both anchor and asset
...
("ttl",) – contract instance/code TTL extended
Contract metadata
